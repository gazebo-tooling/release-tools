...
apt-get install -y cmake debhelper gazebo ros-fuerte-pr2-mechanism ros-fuerte-std-msgs ros-fuerte-common-msgs ros-fuerte-image-common ros-fuerte-geometry ros-fuerte-pr2-controllers ros-fuerte-geometry-experimental ros-fuerte-robot-model-visualization ros-fuerte-image-pipeline
...
ROS_TEST_RESULTS_DIR=$WORKSPACE/build/test_results make test || true
