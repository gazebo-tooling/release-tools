...
set DEPEN_PKGS=assimp boost-core ccd cppzmq cuda dartsim curl dlfcn-win32 eigen3 fcl ffmpeg freeimage gflags glib gts jsoncpp libyaml libzip ogre ogre2 ogre22 openssl protobuf qt5 qwt tinyxml2 zeromq
:: TODO: testing without dartsim
