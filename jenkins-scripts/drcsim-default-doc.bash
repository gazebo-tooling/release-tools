...
# ssh -o StrictHostKeyChecking=no -i $WORKSPACE/id_rsa ubuntu@gazebosim.org sudo rm -rf /var/www/drcsim/api/dev /tmp/drcsim_dev
# scp -o StrictHostKeyChecking=no -i $WORKSPACE/id_rsa -r doxygen/html ubuntu@gazebosim.org:/tmp/drcsim_dev
# ssh -o StrictHostKeyChecking=no -i $WORKSPACE/id_rsa ubuntu@gazebosim.org sudo mv /tmp/drcsim_dev /var/www/drcsim/api/dev
...
# ssh -o StrictHostKeyChecking=no -i $WORKSPACE/id_rsa ubuntu@gazebosim.org sudo mv /tmp/drcsim-dev.pdf /var/www/drcsim/api/drcsim-dev.pdf
DELIM
