...
ignition_collections = [
  ...
  [ name : 'garden',
    ...
    nightly_jobs: [
          'tools'     : [ debbuild: 'ign-tools2'      , branch: 'gz_cmake_project' ],
          'cmake'     : [ debbuild: 'ign-cmake3'      , branch: 'gz_cmake_project' ],
          'utils'     : [ debbuild: 'ign-utils2'      , branch: 'gz_cmake_project' ],
          'math'      : [ debbuild: 'ign-math7'       , branch: 'gz_cmake_project' ],
          'plugin'    : [ debbuild: 'ign-plugin2'     , branch: 'gz_cmake_project' ],
          'common'    : [ debbuild: 'ign-common5'     , branch: 'gz_cmake_project' ],
          'msgs'      : [ debbuild: 'ign-msgs9'       , branch: 'gz_cmake_project' ],
          'rendering' : [ debbuild: 'ign-rendering7'  , branch: 'gz_cmake_project' ],
          'sdformat'  : [ debbuild: 'sdformat13'      , branch: 'gz_cmake_project' ],
          'fuel-tools': [ debbuild: 'ign-fuel-tools8' , branch: 'gz_cmake_project' ],
          'transport' : [ debbuild: 'ign-transport12' , branch: 'gz_cmake_project' ],
          'gui'       : [ debbuild: 'ign-gui7'        , branch: 'gz_cmake_project' ],
          'sensors'   : [ debbuild: 'ign-sensors7'    , branch: 'gz_cmake_project' ],
          'physics'   : [ debbuild: 'ign-physics6'    , branch: 'gz_cmake_project' ],
          'gazebo'    : [ debbuild: 'ign-gazebo7'     , branch: 'gz_cmake_project' ],
          'launch'    : [ debbuild: 'ign-launch6'     , branch: 'gz_cmake_project' ],
          'garden'    : [ debbuild: 'ign-garden'      , branch: 'gz_cmake_project' ],
    ],
  ],
]
  ...
  ignition_brew_ci_job.with
  {
      steps {
        shell("""\
              ...
              /bin/bash -xe "./scripts/jenkins-scripts/lib/project-default-devel-homebrew-amd64.bash" "gz-${gz_collection_name}"
              """.stripIndent())
      }
  }
