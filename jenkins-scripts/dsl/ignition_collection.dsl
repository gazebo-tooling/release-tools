...
[
  ...
  'harmonic' : [
        ...
        'ign_utils-gz-2-win',
        'gz_cmake-ci-gz-cmake3-jammy-amd64.xml',
        'gz_common-ci-gz-common5-jammy-amd64.xml',
        'gz_fuel_tools-ci-main-jammy-amd64.xml',
        'gz_gui-ci-main-jammy-amd64.xml',
        'gz_launch-ci-main-jammy-amd64.xml',
        'gz_math-ci-gz-math7-jammy-amd64.xml',
        'gz_msgs-ci-main-jammy-amd64.xml',
        'gz_physics-ci-gz-physics6-jammy-amd64.xml',
        'gz_plugin-ci-gz-plugin2-jammy-amd64.xml',
        'gz_rendering-ci-main-jammy-amd64.xml',
        'gz_sensors-ci-main-jammy-amd64.xml',
        'gz_sim-ci-main-jammy-amd64.xml',
        'gz_tools-ci-gz-tools2-jammy-amd64.xml',
        'gz_transport-ci-main-jammy-amd64.xml',
        'gz_utils-ci-gz-utils2-jammy-amd64.xml',
        'ignition_cmake-ci-gz-cmake3-homebrew-amd64',
        'ignition_common-ci-gz-common5-homebrew-amd64',
