...
all_branches.each { branch ->
  ...
  OSRFBitbucketHg.create(gazebo_brew_ci_job, "https://bitbucket.org/osrf/gazebo_experimental",
                        "default", "gazebo")
...
all_branches.each { branch ->
  ...
  OSRFBitbucketHg.create(gazebo_win_ci_job,"https://bitbucket.org/osrf/gazebo_experimental",
                         "default", "gazebo")
