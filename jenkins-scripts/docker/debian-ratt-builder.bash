...
sudo -C 'echo "deb http://deb.debian.org/debian experimental main" >> /etc/apt/sources.list'
sudo -C 'echo "deb-src http://deb.debian.org/debian experimental main" >> /etc/apt/sources.list'
sudo apt-get update
mkdir /tmp/work
cd /tmp/work
