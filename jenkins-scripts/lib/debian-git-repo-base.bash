...
apt-get install -y pbuilder fakeroot debootstrap devscripts dh-make ubuntu-dev-tools debhelper cdbs git
...
OSRF_VERSION=\$VERSION\osrf${RELEASE_VERSION}~${ARCH}${RELEASE_ARCH_VERSION}
sed -i -e 's:\$VERSION:\$OSRF_VERSION::' debian/changelog
