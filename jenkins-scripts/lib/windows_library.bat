...
colcon test --build-base "build" --event-handler console_direct+ --install-base "install" --merge-install --packages-select %COLCON_PACKAGE% --executor sequential || goto :error
