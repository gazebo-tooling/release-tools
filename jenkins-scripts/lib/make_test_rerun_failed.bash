...
# Note that flaky_junit_merge.py requires lxml python3 package
if ! make test ARGS="${DEFAULT_MAKE_TEST_ARGS} ${MAKE_TEST_RERUN_ARGS} $@" \
  ...
  for i in ${FAILED_TESTS}; do
    make test ARGS="${DEFAULT_MAKE_TEST_ARGS} -R ${i}\$$" || true
  done
