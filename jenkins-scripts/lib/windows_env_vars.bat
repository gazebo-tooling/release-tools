...
set VCPKG_DEPENDENCIES_LEGACY=assimp boost-core bullet3 ccd console-bridge cppzmq cuda curl dlfcn-win32 eigen3 fcl ffmpeg freeimage gdal gflags glib gts jsoncpp libyaml libzip ogre ogre2 ogre22 ogre-next-23 openssl protobuf pybind11 qt5 qt5-winextras qwt sqlite3 tinyxml2 zeromq
